class Customers::RegistrationsController < Devise::RegistrationsController
  ...
  # PUT /resource
  def update
    # # from https://github.com/plataformatec/devise/blob/master/app/controllers/devise/registrations_controller.rb
    # # modified it so that we can have updates without password
